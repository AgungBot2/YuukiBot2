...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6283120494967@s.whatsapp.net`]
...
//////
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI Yuuki KAZAREAM☕`
			ind = {
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Yuuki KAZAREAM VERIFIED`, //Kasih namalu
                            orderTitle: `Yuuki KAZAREAM VERIFIED`,
                            thumbnail: iye, //Gambarnye
                            sellerJid: '0@s.whatsapp.net' 
                          }
                        }
...
ronove.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const nihkak = (teks) => {
        ...
        const grupinv = (teks) => {
        	grup = ronove.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FEddiGqX38kAxUaIl3zRtl', "groupName": `Yuuki KAZAREAM`, "footerText": "*© ᴹᴿ᭄Didin⁴̅⁰͍⁴̵〆⁩*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
            ronove.relayWAMessage(grup)
        }
const fakeitem = (teks) => {
            ronove.sendMessage(from, teks, text, {
...
const fakewa = (teks) => {        
ronove.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6283120494967?text=Assalamualaikum`}}})
		}
		const fakegrup = (teks) => {        
ronove.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: fgif, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Yuuki KAZAREAM GROUP`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://chat.whatsapp.com/FEddiGqX38kAxUaIl3zRtl`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Yuuki KAZAREAM/n VERIFIED`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6283120494967`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6283120494967`,
                "thumbnailUrl": "https://j.top4top.io/p_20682m4yj0.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6283120494967`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6283120494967@s.whatsapp.net";
...
ptod = "6283120494967@s.whatsapp.net"
        stod = `${sender}`
        uwu = '*``*'
        yoii = '```'
        timestmp = speed();
...
*┃✙◗ thanx to taqi*
*┃✙◗ thanx to vany*
*┗━━━━━━━ •*`, {jpegThumbnail:iye}, [{buttonId:`infobot`,buttonText:{displayText:'INFO BOT'},type:1},{buttonId:`owner`,buttonText:{displayText:'Owner🐣'},type:1},{buttonId:`command`,buttonText:{displayText:'MENU📒'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}}, { quoted : mek })
...
`
                    ...
                    ronove.sendMessage(from, { contentText: `${menu}`, footerText: 'Yuuki KAZAREAM☕', buttons: [{ buttonId: `!command`, buttonText: { displayText: '📙MENU' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: '👥 OWNER' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: iye, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
       case 'hobby':
...
*┃✙◗ thanx to vany*
*┗━━━━━━━ •*`
sendButLocation(from, `${menu}`, `${yoii}Created By Yuuki KAZAREAM${yoii}`, {jpegThumbnail:iye}, [{buttonId:`laporan`,buttonText:{displayText:'REPORT ERROR🛠'},type:1},{buttonId:`owner`,buttonText:{displayText:'OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'SCRIPTℒ⃝🦢'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
break
case 'auu': // by ronove
       reply('apa?0')
...
case 'iggw':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
  reply('https://instagram.com/lufasu.rz')
break
        		        case 'darkneon':
			case 'woodblock':
			case 'paper':
...
`
     ...
     break 
					...
					case 'rainbowshine':
					       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
                    sticWait(from)
                    if (args.length == 0) return reply(`Example: ${prefix + command} Yuuki KAZAREAM`)
                    teki = args.join(" ")
               ...
               if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
        sticWait(from)
					 if (args.length == 0) return reply(`Example: ${prefix + command} Yuuki KAZAREAM|baik`)
                    query = args.join(" ")
					porn = `${body.slice(8)}`
					hub1 = porn.split("|")[0];
					hub2 = porn.split("|")[1];
...
case 'command':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
 listMsg = {
 buttonText: '*SUBREK AGUNG FVNKY',
 footerText: 'Yuuki KAZAREAM',
...
break
case 'downloadmenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
...
fakeyt(menu)
break
case 'wibumenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
menu = `ッ『 Wibu Menu 』ッ
...
fakegroup(menu)
break
case 'nsfwmenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
menu = `ッ『 Nsfw Menu 』ッ
ℒ⃝‼️aktifkan fitur ini dengan ${prefix}nfsw 1
*〆⁩*${prefix}yuri
*〆⁩*${prefix}hentai
...
fakeyt(menu)
break
case 'gcbot':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
menu = `ッ『 Gc Bot 』ッ
GABUNG UTK DPT INFO² MENGENAI BOT YA KAK`
fakegrup(menu)
break
        case 'beliscbot':
        if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
...
「All chat broadcast」`,
			...
			"buttonText": {"displayText": "Yuuki Kazaream"
...
`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `🏷️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'Created by Yuuki AL', imageMessage: imageMsg,
	    ...
	    // console.log(e)
            setTimeout( () => {
			ronove.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Terdaftar Di Yuuki BOT KAZAREAM*`)
		}, 2000)
        break
case  'trapnime':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
...
break
      ...
      case "colong":
        ...
        media = await ronove.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `Yuuki KAZAREAM`;
...
break
     case 'ytmp4': 
      ...
      ronove.sendMessage(from, ini_txt2, image, { quoted: mek, caption: ini_txt })
      ronove.sendMessage(from, ini_txt3, video, { mimetype: 'video/mp4', quoted: mek})
      break
     case 'ytmp3': 
      if (args.length < 1) return reply("Where's the link bro")
      if (!isUrl(args[0]) && !args[0].includes('youtu')) return reply('```Invalid link```')
